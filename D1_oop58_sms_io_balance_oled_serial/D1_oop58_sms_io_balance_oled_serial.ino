//_____D1_oop58_sms_io_balance_oled_serial.ino_181230-190113____
...
#define  FUNCTION58 "Display prepaid SIM balance on oled using HW Serial."
...
//.....choose type of serial by constructor)....................
...
void setup() {
 ...
 while(mod1.requestBalanceSMS()!=GSMMOD_OK) {
  mod1.begin();
  display_.screen6(6,"attempt "+String(++i),'c');
  delay(3000);
 }
