...
Die Messwerte werden mit den Methoden `getsTemperature()` und `getsHumidity()` geholt (ergibt formatierte Zeichenketten).
...
|  *Eigenschaften*                |                                                        |
| ------------------------------- | ------------------------------------------------------ |
| ~ int&nbsp;i2cAddress           | I2C-Adresse (Vorgabewert 0x45, weitere M&ouml;glichkeit 0x44) | ~ int&nbsp;status               | Status der I2C-Kommunikation und der Messwerte         |
