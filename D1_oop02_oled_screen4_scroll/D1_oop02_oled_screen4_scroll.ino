//_____D1_oop02_oled_screen4_scroll.ino_____181215-181215_____
// Screen4: Demo for vertical scrolling of text.
...
#define  VERSION "2018-12-15 D1_oop02_oled_screen4_scroll"
...
void loop() {
 ...
 for(int i=1; i<18; i++)
 {
  ...
  if(i%3==1) align_='c';
  if(i%3==2) align_='r';
  if(i%5==0) display_.screen4i(5,s1,align_);
         else display_.screen4(5,s1,align_);
  delay(400);
 }
}
