//_____D1_oop59_sms_io_balance_oled_sws.ino___190105-190105_____
// Demo class GSMmodule and SoftwareSerial: Send and receive SMS.
...
#define  VERSION59  "2019-01-05 D1_oop59_sms_io_balance_oled_sws"
#define  FUNCTION59 "Display prepaid SIM balance on oled."
#define  OLED_RESET            RST     // D3=GPIO0, D0=GPIO16

#include "src/screen1a/D1_class_Screen1a.h"
#include "src/gsmmodule2/D1_class_GSMmodule2.h"
...
void setup() {
 ...
 if(s3.indexOf("8943102101")>=0) {
  mod1.sendNetwork(String(GSMMOD2_NET_ID3));
  sNetwork=mod1.getsNetwork();
  display_.screen6i(1,sNetwork);
 }
 ...
 while(mod1.requestBalanceSMS()!=GSMMOD2_OK) {
  display_.screen6(6,String(++i),'c');
  delay(2000);
 }
