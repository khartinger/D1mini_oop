# D1 mini: Prepaid Guthaben-Abfrage mittels SMS
Version 2018-12-30, Datei: `D1_oop54_sms_io_balance_serial.ino`   
[English version](./README.md "English version")   

Das Programm fragt das Guthaben der SIM ab und zeigt alle Programmschritte auf der seriellen Schnittstelle.   
...
## Software - Details
Nach dem Programmstart wird die serielle Schnittstelle initialisiert und in einer Schleife gepr&uuml;ft, ob ein Modem angeschlossen ist (Methode `isModule()`).   
...
Anschlie&szlig;end werden einige Informationen angezeigt: Registriertes Netzwerk, SIM-ID, verwendeter Speicher, Nummer der ersten SMS, Anzahl gespeicherter SMS sowie die maximal m&ouml;gliche Anzahl an SMS.   
Nach dem Abschicken der Anfrage wartet der D1 mini auf die Antwort-SMS. Trifft diese ein, wird sie ausgewertet und der Betrag sowie Datum und Uhrzeit der SMS angezeigt.   
In einer Endlosschleife werden alle 15 Sekunden alle gespeicherten SMS angezeigt.
