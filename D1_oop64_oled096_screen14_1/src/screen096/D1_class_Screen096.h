//_____D1_class_Screen96.h____________________191012-191012_____
...
#define DOT         String((char)0xC2)+String((char)0xB7)

class Screen096 : public SSD1306Wire {
 public: //SDA=D2=GPIO4, SCL=D1=GPIO5
  //Screen096() : SSD1306Wire(0x3C,D2,D1,GEOMETRY_128_64) {
...
/*
class Screen96 : public _Adafruit_SSD1306 {
 //-----properties----------------------------------------------
 protected:
  int dotCounter;
 //-----constructor & co----------------------------------------
...
// Created by http://oleddisplay.squix.ch/ Consider a donation
// In case of problems make sure that you are using the font file with the correct version!
const char Monospaced_plain_12[] PROGMEM = {
	0x07, // Width: 7
	0x0F, // Height: 15
	0x20, // First Char: 32
	0xE0, // Numbers of Chars: 224
