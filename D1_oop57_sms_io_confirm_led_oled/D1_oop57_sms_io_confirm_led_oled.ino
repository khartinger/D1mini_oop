//___D1_oop57_sms_io_confirm_led_oled.ino_____181230-181230_____
...
#define  VERSION57  "2018-12-30 D1_oop57_sms_io_confirm_led_oled"
#define  FUNCTION57 "Wait for SMS #led on# or #led off#, send answer SMS""
...
void loop() {
 if(mod1.isSMS1())
 {
  ...
  s2=mod1.getsStatus();                // result of SMS sending
  display_.screen6(7,s2);              // display result
